            ...
            <tbody>
              ...
              ?>
                <tr class="d-flex">
                  ...
                  <td class="col-md-3"><?php echo $val['email']; ?></td>
                  <td class="col-md-3"><?php echo $val['phone']; ?></td>
                  <td class="col-md-2" style="text-align: center;">
                    <!-- <a href="editcategory.php?id=<?php echo $val['id']; ?>" class="btn btn-success btn-md">
                      <span class="fa fa-edit"></span></a> -->
                    <a onclick="return confirm('sure to delete brand?')" href="deletecustomer.php?id=<?php echo $val['id']; ?>" class="btn btn-danger btn-md"><span class="fa fa-trash"></span></a>
                  </td>
                </tr>
              <?php
                $a++;
