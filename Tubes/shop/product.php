      ...
      <nav class="col-md-2 d-none d-md-block bg-light shadow-md sidebar">
        <div class="sidebar-sticky">
          <ul class="nav flex-column mt-3">
            ...
            <li class="nav-item ">
              <a class="nav-link active text-dark" href="product.php">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
          ...
          <div class="btn-toolbar mb-2 mb-md-0">
            <a href="addproduct.php">
              <button class="btn btn-md-5 mr-4 btn-primary ">
                New Product
              </button>
            </a>
          </div>
            ...
            <tbody>
              ...
              ?>
                <tr class="d-flex">
                  ...
                  <td class="col-md-2"><img style="max-height: 120px" src="uploads/product/<?php echo $val['photo'] ?>"></td>
                  <td class="col-md-2"><?php echo $val['name']; ?></td>
                  <td class="col-md-4"><?php echo $val['description']; ?></td>
                  <td class="col-md-1"><?php echo $val['price']; ?></td>
                  <td class="col-md-2" style="text-align: center;">
                    <a href="editproduct.php?id=<?php echo $val['id']; ?>" class="btn btn-success btn-md">
                      <span class="fa fa-edit"></span></a>
                    <a onclick="return confirm('sure to delete product?')" href="deleteproduct.php?id=<?php echo $val['id']; ?>" class="btn btn-danger btn-md"><span class="fa fa-trash"></span></a>
                  </td>
                </tr>
              <?php
                $a++;
