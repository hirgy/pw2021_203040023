    ...
    <nav class="col-md-2 d-none d-md-block bg-light shadow-md sidebar">
        <div class="sidebar-sticky">
          <ul class="nav flex-column mt-3">
            ...
            <li class="nav-item">
              <a class="nav-link active text-dark" href="productbrand.php">
                <span data-feather="file"></span>
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4 mt-3">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
          <h1 class="h2">Manage Product Brand</h1>
          ...
          <table class="table table-striped mb-5">
            ...
            <tbody>
              ...
              ?>
                <tr>
                  <td><?php echo $a ?></td>
                  <td><img style="max-height: 80px; max-width: 100px;" src="uploads/<?php echo $val['photo'] ?>"></td>
                  <td><?php echo $val['name']; ?></td>
                  <td><?php echo $val['description']; ?></td>
                  <td style="text-align: center;">
                    <a href="editbrand.php?id=<?php echo $val['id']; ?>" class="btn btn-success btn-md">
                      <span class="fa fa-edit"></span></a>
                    <a onclick="return confirm('sure to delete brand?')" href="deletebrand.php?id=<?php echo $val['id']; ?>" class="btn btn-danger btn-md"><span class="fa fa-trash"></span></a>
                  </td>
                </tr>
              <?php
                $a++;
